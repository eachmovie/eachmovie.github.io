...
* Many of these are written to run against the recovered EachMovie datasets. Since those datasets are controlled-access, they will be available only from the [EachMovie repository on Zenodo](https://zenodo.org/communities/eachmovie/about), *not* from this public-access GitHub repository.



## Notes on provenance & archival status

Many of the source code files and other historical assets here were originally developed at Digital Equipment Corporation and are thus part of the historical legacy maintained by Hewlett Packard Enterprise (HPE). 
