...
Thanks also to Mike Looney, Vanessa Doherty, Carl Waldspurger, Mark Manasse, and Lyle Ramshaw for their work on EachMovie at SRC, to the Center for Open Science for hosting the permanent EachMovie repository~\cite{EachMovieOSF},\footnote{AUTHOR'S NOTE WHILE IN PUBLICATION: The EachMovie repository has moved to GitHub (\href{https://eachmovie.github.io}{eachmovie.github.io}) and to Zenodo (\href{https://zenodo.org/communities/eachmovie/}{zenodo.org/communities/eachmovie/}).} and to T.S.~Eliot for inspiring the name ``EachMovie''~\cite{Eliot1917}.
\end{acks}
